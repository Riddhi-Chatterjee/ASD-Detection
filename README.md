...
- **NLP (Natural Language Processing):** For understanding and generating verbal instructions.
- **Computer Vision:** For analyzing subject behavior in response to tasks.
...
## Future Work
- Expand task library to incorporate diverse and adaptive challenges.
- Fine-tune the system to cater to various levels of ASD.
- Improve avatar communication for more natural interaction.
